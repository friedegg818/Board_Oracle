...
public class MyUtil {
	...
	public String paging(int current_page, int total_page, String list_url) {
		...
		sb.append("#paginate .curBox {border:1px solid #8E44AD; background: #fff; color:#8E44AD; font-weight:bold;height:28px;padding:4px 7px 4px 7px;margin-left:3px;line-height:normal;vertical-align:middle;}");
